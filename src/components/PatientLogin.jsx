      ...
      <div className="bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-xl max-w-xl w-full border border-gray-100 dark:border-gray-700 animate-fade-in transition-colors duration-300">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              type="email"
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-blue-500 transition"
        ...
        <p className="text-sm text-center text-gray-600 dark:text-gray-300 mt-6">
          ...
          <Link to="/patient-signup" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
            Register here
          </Link>
        </p>
